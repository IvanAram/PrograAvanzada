...
//  BF3
//
//  Created by Sebastián Galguera on 5/3/18.
...
// STRUCT TO HOLD THE BLOWFISH CONTEXT
typedef struct {
	// P ARRAY TO BE XORED WITH BYTES
	// 18 32 BITS INTEGERS
    unsigned long P[16 + 2];
    // S ARRAY FOR TRANSFORMATION FUNCTION
    unsigned long S[4][256];
    // PRODUCT OF THIS IS CIPHER TEXT
} BLOWFISH_CTX;
